...
if (colors[colorChoice]) {
    ...
    if (navElement) {
        ...
        navElement.style.border = `1px solid ${adjustColorBrightness(selectedColors.nav, -20)}`; 
    ...
    document.querySelectorAll(".car").forEach(car => {
        ...
        car.style.borderRadius = "8px"; // rounded corners 
        car.style.padding = "15px"; // padding inside the car boxes
